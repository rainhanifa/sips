...
-- Dumping structure for table illiyin_sips.member
...
-- Dumping data for table illiyin_sips.member: ~0 rows (approximately)
DELETE FROM `member`;
...
CREATE TABLE IF NOT EXISTS `payroll` (
  ...
  `no_letter` int(11) NOT NULL DEFAULT '0',
  `date` date NOT NULL,
  `member_id` int(11) NOT NULL COMMENT 'foreign key to member',
