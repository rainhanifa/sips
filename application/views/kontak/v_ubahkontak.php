                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form class="form-horizontal">
                                ...
                                <center>
                                    <div class="row">
                                         <a href="<?php echo base_url('kontak')?>/index"><button type="button" class="btn btn-primary m-t-15 waves-effect">Simpan</button>
                                        <a href="<?php echo base_url('kontak')?>/index"><button type="button" class="btn btn-danger m-t-15 waves-effect">Batal</button></a>
                                    </div>
                                </center>
