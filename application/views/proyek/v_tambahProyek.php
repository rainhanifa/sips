                            ...
                            <form class="form-horizontal">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="nominal" class="form-control" placeholder="Masukkan Kode Proyek">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="nominal" class="form-control" placeholder="Masukkan Nama Proyek">
                                            </div>
                                        </div>
                                    </div>
                                </div>
